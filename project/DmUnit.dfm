object DM: TDM
  ...
  object FDQueryForINOUTGSM: TFDQuery
    ...
    SQL.Strings = (
      ...
      '    DENSITY,'
      '    PRICE,'
      '    SUMM,  -- not used, doubles  AMOUNT'
      '    NDS,'
      '    WHOLE, -- not used, incorrect value'
      '    LASTUSER_ID,'
      '    UPDATED_AT,'
      '    STATE)'
      ''
      ...
      '    iif(enddatetime < '#39'2019-01-01'#39','#39'18'#39','#39'20'#39') as nds,'
      ...
      '    sum(iif(opa is not null,  ova, r.volume)) as volume,'
      '--    sum(r.amount) as amount'
      '    sum(iif(opa is not null,  oaa, r.amount)) as amount'
      ''
      '    from sessions s'
      '    join'
